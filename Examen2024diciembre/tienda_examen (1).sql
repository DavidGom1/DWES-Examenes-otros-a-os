...
-- Tiempo de generación: 08-12-2024 a las 11:49:44
...
CREATE TABLE `favoritos` (
  `fav_id` int NOT NULL,
  `fav_cliente` int NOT NULL,
  `fav_articulo` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `favoritos` (`fav_id`, `fav_cliente`, `fav_articulo`) VALUES
(2, 1, 2),
(1, 4, 3),
(3, 5, 3),
(4, 7, 4);
...
ALTER TABLE `favoritos`
  ...
  ADD UNIQUE KEY `fav_cliente_articulo` (`fav_cliente`,`fav_articulo`),
  ADD KEY `fk_favoritos_articulos` (`fav_articulo`);
...
--
ALTER TABLE `favoritos`
  ADD CONSTRAINT `fk_favoritos_articulos` FOREIGN KEY (`fav_articulo`) REFERENCES `articulos` (`art_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_favoritos_clientes` FOREIGN KEY (`fav_cliente`) REFERENCES `clientes` (`cli_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
